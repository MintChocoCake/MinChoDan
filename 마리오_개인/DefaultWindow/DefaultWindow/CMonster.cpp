...
//	m_fSpeed = 1.5f;
//
//	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Image/Monster/Monster_00.bmp", L"Monster_00");
//}
//
...
//{
//	POINT Scroll = CScrollMgr::Get_Instance()->GetScroll();
//	//Rectangle(hDC, m_tRect.left + Scroll.x, m_tRect.top + Scroll.y, m_tRect.right + Scroll.x, m_tRect.bottom + Scroll.y);
//
//	HDC	hMonsterDC = CBmpMgr::Get_Instance()->Find_Bmp(L"Monster_00");
