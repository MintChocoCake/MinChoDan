...
typedef struct tagMonster {
	...
	tagMonster(DWORD _dwHP, DWORD _dwStr, BMP_KEY _eBmp, ITEM_ID _eDrop, float _fCX = 53.f, float _fCY = 70.f) {
		dwHP = (DWORD)_dwHP;
		eBmp = _eBmp;
		eDropItem = _eDrop;
		m_fCX = _fCX;
...
static const tagMonster arrMobTable[MONSTER_ID_END] = {
	{ (DWORD)1,(DWORD)10000, BMP_KEY_MONSTER_MUSHROOM, ITEM_ID_NONE },
	{ (DWORD)3,(DWORD)10000, BMP_KEY_MONSTER_GUNNER, ITEM_ID_COIN },
	{ (DWORD)1,(DWORD)10000, BMP_KEY_MONSTER_TUTLE, ITEM_ID_NONE }, 
	{ (DWORD)1,(DWORD)10000, BMP_KEY_MONSTER_MOCOCO, ITEM_ID_NONE },
	{ (DWORD)-1,(DWORD)10000, BMP_KEY_MONSTER_TUNNEL, ITEM_ID_NONE },
	// 보스
	{ (DWORD)10,(DWORD)10000, BMP_KEY_BOSS_CENTER_HEAD, ITEM_ID_NONE, 161.f, 332.f},
	{ (DWORD)10,(DWORD)10000, BMP_KEY_BOSS_LEFT_HEAD, ITEM_ID_NONE, 261.f, 209.f},
	{ (DWORD)10,(DWORD)10000, BMP_KEY_BOSS_RIGHT_HEAD, ITEM_ID_NONE, 261.f, 209.f},
	{ (DWORD)10,(DWORD)10000, BMP_KEY_BOSS_RIGHT_BODY, ITEM_ID_NONE, 215.f, 144.f},
	{ (DWORD)10,(DWORD)10000, BMP_KEY_BOSS_LEFT_BODY, ITEM_ID_NONE, 215.f, 144.f},
	{ (DWORD)10,(DWORD)10000, BMP_KEY_BOSS_BOTTOM_BODY, ITEM_ID_NONE, 514.f, 192.f},
	{ (DWORD)10,(DWORD)10000, BMP_KEY_BOSS_WING, ITEM_ID_NONE, 590.f, 296.f},
	{ (DWORD)10,(DWORD)10000, BMP_KEY_BOSS_TAIL, ITEM_ID_NONE, 406.f, 146.f},
};
